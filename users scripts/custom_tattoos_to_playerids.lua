...
--- This script can add/update leftarm tattoos
...
while true do
    ...
    if is_record_valid then
        ...
        local tattooid = tattoos_map[playerid]
        if playerid > 0 and tattooid then
            game_db_manager:set_table_record_field_value(current_addr, "players", "tattooleftarm", tattooid)
